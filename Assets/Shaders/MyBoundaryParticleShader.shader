Shader "Unlit/BoundaryParticleShader"
{
	CGINCLUDE
	#include "UnityCG.cginc"
	#include "CS/Boundary/BoundaryData.cginc"
	...
	StructuredBuffer<BoundaryParticle> _ParticleBuffer;
	...
	v2g vert(uint id : SV_VertexID) // SV_VertexID:
	{
		...
		v2g o = (v2g)0;
		BoundaryParticle p = _ParticleBuffer[id];
